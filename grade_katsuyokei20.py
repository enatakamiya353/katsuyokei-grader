...
# -*- coding: utf-8 -*-
"""
国語 活用の種類・活用形 マークシートテスト Ver.4.0（縦書き・20問・5/6択混在・解答用紙1枚）
...
出力: 採点結果_活用形20問_ver4.csv （このスクリプトと同じフォルダに作成）
"""
import argparse
import csv
import json
...
# （Ver.3.0以降は【2】が8問とも直接出題形式で1ページに収まるため、Ver.2.0の8ページ構成より1枚少ない）
# 0始まりページ番号：
...
def main():
    parser = argparse.ArgumentParser(
        description="国語 活用の種類・活用形 マークシートテスト Ver.4.0(20問・5/6択混在) 自動採点"
    )
    ...
    if rows:
        ...
        out_path = BASE_DIR / "採点結果_活用形20問_ver4.csv"
